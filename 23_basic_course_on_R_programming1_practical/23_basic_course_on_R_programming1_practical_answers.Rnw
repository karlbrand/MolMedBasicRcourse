%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Program: 23_basic_course_on_R_programming1_answers.Rnw                  %
...
@
\color{red}
The first one {\tt FALSE} because the first statement before \texttt{\&\&} is {\tt FALSE}. The second one is {\tt TRUE} because one of the two statements to the left and right of {\tt ||} is {\tt TRUE}. 
\color{black}
