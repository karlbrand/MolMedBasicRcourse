...
\author{Karl Brand\footnote{brandk@gmauil.com}\hspace{1mm} and Elizabeth Ribble\footnote{emcclel3@msudenver.edu}}
\date{14-18 May 2018}
...
to (currently) 1560 software packages for omics and life science
analyses.  \url{http://www.bioconductor.org/}

\includegraphics[width=4.3in]{companies.png}\\
Used internally by lots of big, profitable companies. \url{https://www.datasciencecentral.com/profiles/blogs/list-of-companies-using-r}
