...
lmbh
@
{\tt vitaminB12} is statistically significant ($p$-value less than 0.05). It explains about 8.8 percent of the variability in {\tt loghc}. The model with the estimates is
\begin{center}
