...
## 1.2.1 Create a vector (using {c()}) called {a} (i.e. assign it to an 
##       object called {a}) with four elements which are the integers 
##       5 to 8 (inclusive).
...
## 1.2.16 item Display only the 2nd row of {m}.
